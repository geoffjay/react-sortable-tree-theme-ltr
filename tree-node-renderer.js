...
class CustomThemeTreeNodeRenderer extends Component {
  constructor (props) {
    super(props)
...
CustomThemeTreeNodeRenderer.defaultProps = {
  swapFrom: null,
  swapDepth: null,
  swapLength: null,
  canDrop: false,
...
CustomThemeTreeNodeRenderer.propTypes = {
...
export default CustomThemeTreeNodeRenderer;
